...
const baseComponentToDisplayMap = {
    // 2
    "化": "亻",
    "个": "𠆢",
    "并": "丷",
...
export const alternateComponentInfo = {
    // 1
    "乚": {
        base: "乙",
        strokes: 1,
...
export function getBaseComponent(comp) {
...
export function getComponentStrokeNumber(comp, radk) {
...
export function getDisplayComponent(comp) {
